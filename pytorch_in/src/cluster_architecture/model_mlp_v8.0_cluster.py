...
amount = 300      # Tamanho do dataset  |  se negativo, usará o data set todo
...
MODE = 1              # 0 para treinar a rede              | 1 para apenas rodar a rede em uma serie de dados
...
if len(sys.argv)>3:
    ...
    hidden_size = int(sys.argv[3])      # Quantidade de camadas

# Generalizando código para ser usado em mais de uma máquina
caminho_local = '/mnt/c/Users/micro/OneDrive/Documentos/Faculdade/neural_network_2023/pytorch_in/src/cluster_architecture'
caminho_cluster = '/home/lucasdu/algoritmo/cluster_architecture'
dir_base = ''
if LOCAL == 1:
...
def train(data):
    ...
    mlp = MLP(input_dim=1, output_dim=1, hidden_dim=hidden_size,num_hidden_layers=hidden_layers)
...
def save_model(model):
    ...
    ), f'{dir_base}/model_mlp_v7.0_cluster.pth')
